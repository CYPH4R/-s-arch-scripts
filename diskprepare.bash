...
mkfs.ext4 /dev/sda1
mount /dev/sda1 /mnt
pacstrap /mnt base base-devel linux linux-firmware vim git grub sudo xorg xorg-xinit nvidia nitrogen picom xmonad firefox networkmanager go
genfstab -U /mnt >> /mnt/etc/fstab
cp ./lazy.bash /mnt/lazy.bash
cp ./yay-installer.bash /mt/yay-installer.bash
